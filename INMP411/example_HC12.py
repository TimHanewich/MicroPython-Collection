...
# Set up HC12
uart = UART(1, rx=Pin(5), tx=Pin(4), baudrate=9600)
hc12 = HC12(uart, 15)
...
for i in range(0, 20):
    ...
    # Send volume
    ToSend:str = "vol:" + str(round(vol, 5))
    print("Sending volume via HC-12... '" + ToSend + "'")
    hc12.send(ToSend.encode("ascii"))
    print("Sent!")
